...
\author{
    ...
    & \multicolumn{2}{c}{\tiny \textcolor[rgb]{0.9,0.9,0.9}{Participated in \& did the coursework [Y/N]?}} 
    	\\ 
		APALE,~Jedrek~Mari~Gabriel~G.~(12174998) & Y & \includegraphics[height=5ex]{JED SIGNATUJRE.png}
		\\ 
		CORTES,~Marc~Jose~L.~(12125296)     & Y & \includegraphics[height=5ex]{cortes-esig}
		\\ 
		MASINDA,~Gian~Kyle~G.~(12186228)  & Y & \includegraphics[height=5ex]{GIANSIG}
		\\ 
        SANCHEZ,~Ronan~V.~(121---)  & Y & \includegraphics[height=5ex]{MCR_signature} 
		\\
	\end{tabular}
	}
...
\IEEEpubid{\makebox[\columnwidth]{LBYEC4F - EK3 \hfill DLSU}%
